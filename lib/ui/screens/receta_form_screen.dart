  ...
  void _agregarInsumo(Insumo insumo) {
    setState(() {
      _insumosSeleccionados.add(
        RecetaInsumo(insumo: insumo, cantidad: 0, unidadReceta: insumo.unidad),
      );
    });
  }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      onSaved: (value) => _porciones = int.parse(value ?? '1'),
                    ),
                    ...
                    Row(
                      children: [
                        ...
                        const Spacer(),
                        TextButton.icon(
                          onPressed: _todosInsumos.isEmpty ? null : _mostrarDialogoAgregarInsumo,
                    ...
                    if (_insumosSeleccionados.isEmpty)
                      ...
                      ..._insumosSeleccionados.map((ri) => _InsumoRecetaTile(
                            ri: ri,
